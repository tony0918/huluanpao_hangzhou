			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="http://huluanpao.com" target="_blank">BRAND WEBSITE</a></li>
						<li class=""><a href="<?php echo $baseUrl; ?>en">HOME</a></li>
						<li class="dropdown">
						...
						<li class="last flag">
							<a href="<?php echo $baseUrl; ?>" class="pull-left"><img src="<?php echo $baseUrl; ?>images/flag1.jpg" alt=""></a>
							<a href="<?php echo $baseUrl; ?>en" class="pull-left active"><img src="<?php echo $baseUrl; ?>images/flag2.jpg" alt=""></a>
						</li>
					</ul>
				</div><!-- /.navbar-collapse -->
			</div><!-- /.container-fluid -->
